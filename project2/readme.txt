...
parser 目前支援 if-then, if-then-else, if-else, if-elseif-else, for, while, do while, return, 
                switch, compare operator, modular operator, include STD library、多個參數的且名稱可為 id 的 function
